...
import ar.edu.um.isa.config.audit.AuditEventConverter;
import ar.edu.um.isa.domain.PersistentAuditEvent;
...
import static ar.edu.um.isa.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
